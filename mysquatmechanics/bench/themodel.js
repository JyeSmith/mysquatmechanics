...
function update(newValue)
{
	...
	document.getElementById("upperarmvalue").innerHTML = upperarm.concat(" cm (", (upperarm/2.54).toFixed(1), "\")");
	document.getElementById("forearmvalue").innerHTML = forearm.concat(" cm (", (forearm/2.54).toFixed(1), "\")");
	document.getElementById("shouldervalue").innerHTML = shoulder.concat(" cm (", (shoulder/2.54).toFixed(1), "\")");
	document.getElementById("gripvalue").innerHTML = grip.concat(" cm (", (grip/2.54).toFixed(1), "\")");
	document.getElementById("flarevalue").innerHTML = flareangle.concat(" Deg");
	document.getElementById("heightvalue").innerHTML = height.concat(" cm (", (height/2.54).toFixed(1), "\")");
	document.getElementById("travelvalue").innerHTML = travel.concat(" cm (", (travel/2.54).toFixed(1), "\")");
